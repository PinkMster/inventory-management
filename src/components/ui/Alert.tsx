      ...
      <div className="flex">
        ...
        {onClose && (
          <div className="pl-3 ml-auto">
            <button
              type="button"
              className="inline-flex rounded-md p-1.5 text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-blue-50 focus:ring-blue-500"
              onClick={onClose}
            >
